  ...
  return (
    <div>
      <div>
        ...
        <div className='h-[86vh] lg:h-[47.5vh] flex flex-col lg:flex-row 
        lg:gap-x-4'>
          {/* box 1 */}
          <div className='bg-green-400/20 flex-1 h-full overflow-y-auto 
          ...
          {/* box 2 */}
          <div className='bg-yellow-400 flex-1 h-full lg:max-w-[40%] flex flex-col 
