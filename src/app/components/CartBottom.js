  ...
  return (
    <>
      ...
      {modal && ( 
        ...
        lg:rounded-[30px] lg:fixed lg-top-[50%] lg:left-[50%] lg:translate-x-
        [-50%] lg:translate-y-[50%] outline-none' 
        isOpen={modal} 
        style={modalStyles} 
        ...
        >
          ...
          <div
          onClick={closeModal}
          className='absolute z-30 right-2 top-2 hover:scale-110 duration-200 
          cursor-pointer'
          >
